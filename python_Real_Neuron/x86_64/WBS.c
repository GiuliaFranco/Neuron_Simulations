...
#define nrn_init _nrn_init__WBS
#define _nrn_initial _nrn_initial__WBS
#define nrn_cur _nrn_cur__WBS
#define _nrn_current _nrn_current__WBS
#define nrn_jacob _nrn_jacob__WBS
#define nrn_state _nrn_state__WBS
#define _net_receive _net_receive__WBS 
#define func func__WBS 
#define states states__WBS 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 6, "cvodeieq");
 	...
 	ivoc_help("help ?1 WBS /Users/giuliafranco/Desktop/Neuron_Simulations/mods/WBS.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "WBS.mod   squid sodium, potassium, and leak channels";
...
static double _nrn_current(double _v){double _current=0.;v=_v;{ {
   m = am / ( am + bm ) ;
   ina = gnabar * ( pow( m , 3.0 ) * h * s ) * ( v - ena ) ;
 ...
 v=_v;
{
  ...
  ek = _ion_ek;
 { error =  states();
 if(error){fprintf(stderr,"at line 59 in file WBS.mod:\n	SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }  }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/giuliafranco/Desktop/Neuron_Simulations/mods/WBS.mod";
static const char* nmodl_file_text = 
